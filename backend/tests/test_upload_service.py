...
async def test_process_upload_success():
    ...
    mock_storage.upload_file.return_value = "https://fake-supabase.com/portfolio-media/test/123-safe-name.png"
    ...
    upload_file = UploadFile(filename="My Cool Image.png", file=fake_file, headers={"content-type": "image/png"})
